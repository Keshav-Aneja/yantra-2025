...
export default function HeroCenter() {
  return (
    <div className="relative flex  flex-row justify-center items-center w-wrapper text-white font-roboto overflow-hidden h-[92.9vh] border-border border-x">
      ...
      <div className="flex justify-center items-center w-1/2 mt-28">
        <div className="grid grid-rows-16 w-full">
          ...
          <div className="row-span-1 text-sm  border border-[#353539] border-b-0 pr-6  uppercase h-full flex items-center justify-end">
          ...
          <div className="row-span-1 text-sm flex items-center justify-end text-gray-400 text-right border border-[#353539] pr-6  uppercase">
            AND MUCH MORE
          </div>
